...
// EdDSA/Ed25519 signs roughly an order of magnitude faster than RSA-2048 — a
// real cost on the 1c1g deployment, where every login/refresh issues a JWT and
// every authenticated request verifies one.
